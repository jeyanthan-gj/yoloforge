...
.cog-footer { background: rgba(250,245,247,0.8); border-top: 1px solid rgba(217,70,168,0.12); padding: 18px 32px; display: flex; flex-wrap: wrap; align-items: center; justify-content: space-between; gap: 12px; font-size: 12px; color: var(--text-tertiary); }
.cog-footer a { color: var(--text-secondary); text-decoration: none; transition: color 0.2s; }
.cog-footer a:hover { color: var(--accent-primary); }
.cog-footer-links { display: flex; align-items: center; gap: 16px; flex-wrap: wrap; }
.cog-footer-icon { display: flex; align-items: center; gap: 5px; font-size: 12px; transition: color 0.2s; }
.cog-footer-icon:hover { color: var(--accent-primary); }
      ...
      <footer className="cog-footer">
        <div>
          ...
          <a href="https://cognivus-ai.netlify.app/" target="_blank" rel="noopener noreferrer"
            style={{color: "var(--accent-primary)", fontWeight: 700}}>Cognivus</a>
          &nbsp;·&nbsp;
          Need support or a feature?{" "}
          <a href="https://wa.me/919384019167" target="_blank" rel="noopener noreferrer"
            style={{color: "#22c55e", fontWeight: 600}}>Chat with us →</a>
        </div>
        <div className="cog-footer-links">
          <a href="https://wa.me/919384019167" target="_blank" rel="noopener noreferrer" className="cog-footer-icon" title="WhatsApp">
          ...
          <a href="mailto:cognivus88@gmail.com" className="cog-footer-icon" title="Email">
            <svg width="14" height="14" fill="#ef4444" viewBox="0 0 24 24"><path d="M24 5.457v13.909c0 .904-.732 1.636-1.636 1.636h-3.819V11.73L12 16.64l-6.545-4.91v9.273H1.636A1.636 1.636 0 010 19.366V5.457c0-2.023 2.309-3.178 3.927-1.964L5.455 4.64 12 9.548l6.545-4.910 1.528-1.145C21.69 2.28 24 3.434 24 5.457z"/></svg>
            cognivus88@gmail.com
          </a>
          <a href="https://www.instagram.com/cogni_vus/" target="_blank" rel="noopener noreferrer" className="cog-footer-icon" title="Instagram">
          ...
          <a href="https://www.linkedin.com/company/116544347/" target="_blank" rel="noopener noreferrer" className="cog-footer-icon" title="LinkedIn">
            <svg width="14" height="14" fill="#0077b5" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
            LinkedIn
          </a>
          <a href="https://www.facebook.com/profile.php?id=61589537544502" target="_blank" rel="noopener noreferrer" className="cog-footer-icon" title="Facebook">
            <svg width="14" height="14" fill="#1877f2" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
            Facebook
          </a>
          <a href="https://github.com/cognivus" target="_blank" rel="noopener noreferrer" className="cog-footer-icon" title="GitHub">
