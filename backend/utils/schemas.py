...
Fix: dataset_path added to PipelineState so it is a proper declared field
     rather than an injected extra that confused type checkers.
"""
...
class PipelineState(TypedDict):
    config:           dict
    dataset_path:     Optional[str]   # FIX: declared here; updated by clean/split nodes
    # tool results
